...
{
	struct FString                                     Tag;                                                      // 0x0008(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	struct FText                                       CategoryText;                                             // 0x0018(0x0018) (Edit, BlueprintVisible)
	struct FString                                     DevComment;                                               // 0x0030(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
